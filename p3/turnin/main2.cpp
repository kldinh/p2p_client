...
{   
    ...
    tcp_encrp_message[4] =  0;   tcp_encrp_message[5] = 13;
 ...
 //   message[0] = 90;  message[1] = 90; message[2] = 'K'; message[3] = 'E';
   // tcp_encrp_message[4] =  'V';   tcp_encrp_message[5] = 'I';
   // tcp_encrp_message[6] = 'N';
   // tcp_encrp_message[7] = '\0'; 

   // PrivateEncryptDecrypt(message,8,sequence_number);

    GenerateRandomString(message, 64, sequence_number);
    
    for(int i =0; i < 64; i++)
    {   
        tcp_encrp_message[6+i] = message[i];
    }


    Result = write(tcp_SocketFileDescriptor, tcp_encrp_message, 70);
    if(Result < 0)
